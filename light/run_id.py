...
def run_i_delete(name_data, param_path,i):
    ...
    for j in range(len(params_list)):
        ...
        if i == 1:
            query = i_delete_1(params)
            time = delete(jwt, query)
        elif i == 2:
            query = i_delete_2(params)
            time = delete(jwt, query)
        elif i == 3:
            query = i_delete_3(params)
            time = delete(jwt, query)
        elif i == 4:
            query = i_delete_4(params)
            time = delete(jwt, query)
        elif i == 5:
            query = i_delete_5(params)
            time = delete(jwt, query)
        elif i == 6:
            query = i_delete_6(params)
            time = delete(jwt, query)
        elif i == 7:
            query = i_delete_7(params)
            time = delete(jwt, query)
        elif i == 8:
            query = i_delete_8(params)
            time = delete(jwt, query)
        exe_time = time
        if j != 0:
            total_time += exe_time
