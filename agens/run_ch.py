...
def run_i_check(name_data, param_path,i):
    ...
    for j in range(len(params_list)):
        ...
        if i == 1:
            start = timer()
            runner.i_check_1(params)
            end = timer()
        elif i == 2:
            start = timer()
            runner.i_check_2(params)
            end = timer()
        elif i == 3:
            start = timer()
            runner.i_check_3(params)
            end = timer()
        elif i == 4:
            start = timer()
            runner.i_check_4(params)
            end = timer()
        elif i == 5:
            start = timer()
            runner.i_check_5(params)
            end = timer()
        elif i == 6:
            start = timer()
            runner.i_check_6(params)
            end = timer()
        elif i == 7:
            start = timer()
            runner.i_check_7(params)
            end = timer()
        elif i == 8:
            start = timer()
            runner.i_check_8(params)
            end = timer()
        exe_time = end - start
        if j!=0:
            total_time += exe_time
